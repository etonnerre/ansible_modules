...
class NetboxDcimModule(NetboxModule):
    ...
    def run(self):
        ...
        if data.get("name"):
            ...
            if isinstance(self.module.params["data"]["device"], dict) and self.module.params["data"]["device"].get('name'):
                device_name = self.module.params["data"]["device"]["name"]
            elif isinstance(self.module.params["data"]["device"], dict) and self.module.params["data"]["device"].get('slug'):
                device_name = self.module.params["data"]["device"]["slug"]
            else:
                device_name = self.module.params["data"]["device"]
            if isinstance(self.module.params["data"]["module_bay"], dict) and self.module.params["data"]["module_bay"].get('name'):
                module_bay = self.module.params["data"]["module_bay"]["name"]
            elif isinstance(self.module.params["data"]["module_bay"], dict) and self.module.params["data"]["module_bay"].get('slug'):
                module_bay = self.module.params["data"]["module_bay"]["slug"]
            else:
                module_bay = self.module.params["data"]["module_bay"]
            if isinstance(self.module.params["data"]["module_type"], dict) and self.module.params["data"]["module_bay"].get('model'):
                module_type = self.module.params["data"]["module_type"]["model"]
            elif isinstance(self.module.params["data"]["module_type"], dict) and self.module.params["data"]["module_bay"].get('part_number'):
        ...
        # self._handle_errors(msg="%s" % (nb_endpoint))
